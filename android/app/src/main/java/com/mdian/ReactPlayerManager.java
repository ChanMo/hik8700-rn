...
//import com.facebook.react.modules.fresco;
...
public class ReactPlayerManager extends SimpleViewManager<SurfaceView> {
    public static final String REACT_CLASS = "RCTPlayerView2";
    ReactApplicationContext playerContext;

    public ReactPlayerManager(ReactApplicationContext reactContext) {
        playerContext = reactContext;
    }
